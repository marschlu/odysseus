  ...
  detail.innerHTML = `
    ...
    <div class="gallery-detail-body">
      ...
      <div class="gallery-detail-sidebar">
        ...
        ${img.source_nextcloud_account ? `<div class="gallery-detail-section"><label>Nextcloud</label><div style="display:flex;align-items:center;gap:4px;"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="opacity:0.7;flex-shrink:0;"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg><span style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${_esc(img.source_nextcloud_path || '')}</span></div></div>` : ''}
