...
from .nextcloud_tools import NextcloudListTool, NextcloudReadFileTool, NextcloudWriteFileTool
...
TOOL_HANDLERS = {
    ...
    "nextcloud_write_file": NextcloudWriteFileTool().execute,
}
...
TOOL_TAGS = {"bash", "python", "web_search", "web_fetch", "read_file", "write_file", "edit_file",
             ...
             "nextcloud_list", "nextcloud_read_file", "nextcloud_write_file",
